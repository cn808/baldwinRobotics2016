 ...
 *
 */
public class ControlSallyLowerArmCmd extends Command {
    ...
    public ControlSallyLowerArmCmd(int dir) {
    ...
    protected void initialize() {
    	timer.start();
    	if( m_dir==EXTEND) 
    		RobotMap.sallyArmLowerArmMotor.set(ARM_SPEED_UP);
    	else if( m_dir==RETRACT )
    		RobotMap.sallyArmLowerArmMotor.set(+ARM_SPEED_DN);
