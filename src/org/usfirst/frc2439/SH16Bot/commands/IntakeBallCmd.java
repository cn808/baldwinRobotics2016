...
public class IntakeBallCmd extends Command {
    ...
    protected void execute() {
    	//RobotMap.ballIntakeIntakeMotor.set(.5);
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
    	//return !Robot.ballIntake.intake();
        // return RobotMap.ballIntakeIntakeLimitSw.get();
    	return !Robot.oi.intakeBallBtn.get(); //SCHEN don't want timer during intake //|| timer.get()>1.5;
    
        /*
        if( RobotMap.ballIntakeIntakeLimitSw.get() )
        {
        	return true;
        }
        else
