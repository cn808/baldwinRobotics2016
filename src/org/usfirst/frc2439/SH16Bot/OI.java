...
public class OI {
    ...
    public JoystickButton extendLiftBtn;
    public JoystickButton retractLiftBtn;
    public JoystickButton manualIntakeArmBtn;
    public JoystickButton sallyLowerArmBtn;
    public JoystickButton sallyUpperArmBtn;
    public JoystickButton lockPinBtn;
    public JoystickButton unlockPinBtn;
    public JoystickButton autoDriveStraightBtn;
    public JoystickButton autoTurnToGoalBtn;
    
    public Joystick btnBox;
    public JoystickButton bbtn1;
    public JoystickButton bbtn2;
    public JoystickButton bbtn3;
    public JoystickButton bbtn4;
    public JoystickButton bbtn5;
    public JoystickButton bbtn6;
    ...
    public OI() {
        ...
        //lowerGateBtn = new JoystickButton(leftJS, 7);
        //lowerGateBtn.whenPressed(new LowerGateCmd());
        //liftGateBtn = new JoystickButton(leftJS, 6);
        //iftGateBtn.whenPressed(new LiftGateCmd());
        lockPinBtn = new JoystickButton(leftJS, 10);
        lockPinBtn.whenPressed(new LockPinCmd());
        unlockPinBtn = new JoystickButton(leftJS, 11);
        unlockPinBtn.whenPressed(new UnlockPinCmd());
        ...
        ejectBallBtn.whenPressed(new EjectBallCmd());
        intakeBallBtn = new JoystickButton(leftJS, 4);
        intakeBallBtn.whenPressed(new IntakeBallCmd());
        lowerIntakeBtn = new JoystickButton(leftJS, 7);
        lowerIntakeBtn.whenPressed(new LowerIntakeCmd());
        raiseIntakeBtn = new JoystickButton(leftJS, 6);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        retractLiftBtn = new JoystickButton(leftJS,8);
        retractLiftBtn.whenPressed(  new RetractGateArmCmd() );
        extendLiftBtn = new JoystickButton(leftJS,9);
        extendLiftBtn.whenPressed(  new ExtendGateArmCmd() );
        manualIntakeArmBtn = new JoystickButton(leftJS,3);
        manualIntakeArmBtn.whenPressed( new MoveIntakeCmd() );
        sallyLowerArmBtn = new JoystickButton(leftJS,2);
        sallyLowerArmBtn.whenPressed( new MoveSallyLowerArmCmd() );
        sallyUpperArmBtn = new JoystickButton(leftJS,1);
        sallyUpperArmBtn.whenPressed( new MoveSallyUpperArmCmd() );

        autoDriveStraightBtn = new JoystickButton(rightJS,5);
        autoDriveStraightBtn.whenPressed( new DriveStraightCmd(.8,9500.) );
        autoTurnToGoalBtn = new JoystickButton(rightJS,6);
        autoTurnToGoalBtn.whenPressed( new TurnToAngleCmd(56.) );
        
        btnBox = new Joystick(0);
        bbtn1 = new JoystickButton( btnBox,1 );
        bbtn1.whenPressed(new RaiseIntakeCmd());
        bbtn2 = new JoystickButton( btnBox,2 );
        bbtn2.whenPressed(new LowerIntakeCmd());
        bbtn3 = new JoystickButton( btnBox,3 );
        bbtn3.whenPressed(new ResetGateLiftCmd());
        bbtn4 = new JoystickButton( btnBox,4 );
        bbtn5 = new JoystickButton( btnBox,5 );
        bbtn5.whenPressed(new ExtendCopleyArmCmd());
        bbtn6 = new JoystickButton( btnBox,6 );
        bbtn6.whenPressed(new RetractCopleyArmCmd());
